...
var clearFnc = function clearFnc() {
  results.textContent = null;
};

var plusFnc = function plusFnc() {
  results.textContent += '+';
};

var minusFnc = function minusFnc() {
  results.textContent += '-';
};

var multiplyFnc = function multiplyFnc() {
  results.textContent += '*';
};

var divideFnc = function divideFnc() {
  results.textContent += '/';
};

// Functions to display numbers
var zeroFnc = function zeroFnc() {
  results.textContent += 0;
};

var oneFnc = function oneFnc() {
  results.textContent += 1;
};

var twoFnc = function twoFnc() {
  results.textContent += 2;
};

var threeFnc = function threeFnc() {
  results.textContent += 3;
};

var fourFnc = function fourFnc() {
  results.textContent += 4;
};

var fiveFnc = function fiveFnc() {
  results.textContent += 5;
};

var sixFnc = function sixFnc() {
  results.textContent += 6;
};

var sevenFnc = function sevenFnc() {
  results.textContent += 7;
};

var eightFnc = function eightFnc() {
  results.textContent += 8;
};

var nineFnc = function nineFnc() {
  results.textContent += 9;
};

var decimalFnc = function decimalFnc() {
  results.textContent += '.';
};
